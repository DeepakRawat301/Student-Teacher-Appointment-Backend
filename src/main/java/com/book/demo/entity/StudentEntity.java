...
public class StudentEntity
{
    ...
    public StudentEntity(@NonNull String username, @NonNull String name, @NonNull String mail,
                         @NonNull Long phone, @NonNull String password,
                         @NonNull String department, @NonNull String course,
